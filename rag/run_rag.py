...
class Config:
    """配置类,存储所有需要的参数"""
    model_path = "model/qwen2chat_int4"
    tokenizer_path = "model/qwen2chat_int4"
    question = "How does Llama 2 perform compared to other open-source models?"
    data_path = "rag/data/llamatiny.pdf"
    persist_dir = "rag/chroma_db"
    embedding_model_path = "model/qwen2chat_src/AI-ModelScope/bge-small-zh-v1___5"
    max_new_tokens = 64
